...
namespace ZtxFrameWork.Data
{
    ...
    public class ZtxDB : DbContext
    {
        ...
        public static void Init(ZtxDB context)
        {
            ...
            var parentMoudle = context.Modules.Where(t => t.ModuleTitle == "系统管理").FirstOrDefault();
            if (parentMoudle == null)
            {
                ...
                context.Modules.Add(new Model.Module() { DocumentType = "ModuleCollectionView", Parent = p, ModuleTitle = "系统模块", ModuleInfo = Model.ModuleInfo.MoudleAction });
                context.Modules.Add(new Model.Module() { DocumentType = "分店CollectionView", Parent = p, ModuleTitle = "分店", ModuleInfo = Model.ModuleInfo.MoudleAction });
                context.Modules.Add(new Model.Module() { DocumentType = "单位CollectionView", Parent = p, ModuleTitle = "单位", ModuleInfo = Model.ModuleInfo.MoudleAction });
                context.Modules.Add(new Model.Module() { DocumentType = "重量单位CollectionView", Parent = p, ModuleTitle = "重量单位", ModuleInfo = Model.ModuleInfo.MoudleAction });
                context.Modules.Add(new Model.Module() { DocumentType = "材质CollectionView", Parent = p, ModuleTitle = "材质", ModuleInfo = Model.ModuleInfo.MoudleAction });
                context.Modules.Add(new Model.Module() { DocumentType = "黄金种类CollectionView", Parent = p, ModuleTitle = "黄金种类", ModuleInfo = Model.ModuleInfo.MoudleAction });
                context.Modules.Add(new Model.Module() { DocumentType = "饰品类别CollectionView", Parent = p, ModuleTitle = "饰品类别", ModuleInfo = Model.ModuleInfo.MoudleAction });
                context.Modules.Add(new Model.Module() { DocumentType = "饰品类型CollectionView", Parent = p, ModuleTitle = "饰品类型", ModuleInfo = Model.ModuleInfo.MoudleAction });
                context.Modules.Add(new Model.Module() { DocumentType = "饰品CollectionView", Parent = p, ModuleTitle = "饰品", ModuleInfo = Model.ModuleInfo.MoudleAction });
        ...
        public ZtxDB() : base("Data Source=127.0.0.1;Initial Catalog=ztxFrameWork2;Integrated Security=True")
        {
