...
namespace ZtxFrameWork.UI.ViewModels
{
    ...
    public class DbOperatorLogCollectionViewModel : CollectionViewModel<DbOperatorLog, ZtxDB, long>
    {
        ...
        protected DbOperatorLogCollectionViewModel() : base(DbFactory.Instance, x => x.DbOperatorLogs, query => query.OrderByDescending(x=>x.OperatorOn), x => x.ID,permissionTitle: "单据状态更改日志")
        {
