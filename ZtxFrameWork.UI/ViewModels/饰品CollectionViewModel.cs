...
namespace ZtxFrameWork.UI.ViewModels
{
    ...
    public class 饰品CollectionViewModel : CollectionViewModel<饰品, ZtxDB, long>
    {
        ...
        protected 饰品CollectionViewModel() : base(DbFactory.Instance, x => x.饰品s, query => query.Include(t => t.品名).Include(t => t.饰品类型).Include(t => t.石头颜色).Include(t => t.电镀方式).Include(t=>t.材质).OrderByDescending(x => x.编号).Take(App.ViewTopCount), x => x.ID,t=>InitEntity(t), permissionTitle: "饰品")
        {
