...
{
    [POCOViewModel]
    public class 销售单明细表_ExpressionViewModel : EntityExpressionBuilder<销售单明细>
    {
        public static 销售单明细表_ExpressionViewModel Create(IEnumerable<string> hiddenProperties, IEnumerable<string> additionalProperties)
        {
            return ViewModelSource.Create(() => new 销售单明细表_ExpressionViewModel(hiddenProperties, additionalProperties));
        }

        protected 销售单明细表_ExpressionViewModel(IEnumerable<string> hiddenProperties, IEnumerable<string> additionalProperties) : base(hiddenProperties, additionalProperties)
        {
            Init();
        }
