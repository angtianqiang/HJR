...
{
    [POCOViewModel]
    public class 应付款明细表_ExpressionViewModel : EntityExpressionBuilder<入库单>
    {
        public static 应付款明细表_ExpressionViewModel Create(IEnumerable<string> hiddenProperties, IEnumerable<string> additionalProperties)
        {
            return ViewModelSource.Create(() => new 应付款明细表_ExpressionViewModel(hiddenProperties, additionalProperties));
        }

        protected 应付款明细表_ExpressionViewModel(IEnumerable<string> hiddenProperties, IEnumerable<string> additionalProperties) : base(hiddenProperties, additionalProperties)
        {
            Init();
        }
