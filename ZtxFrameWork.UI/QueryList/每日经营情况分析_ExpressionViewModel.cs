...
{
    [POCOViewModel]
    public class 每日经营情况分析_ExpressionViewModel : EntityExpressionBuilder<销售单明细>
    {
        public static 每日经营情况分析_ExpressionViewModel Create(IEnumerable<string> hiddenProperties, IEnumerable<string> additionalProperties)
        {
            return ViewModelSource.Create(() => new 每日经营情况分析_ExpressionViewModel(hiddenProperties, additionalProperties));
        }

        protected 每日经营情况分析_ExpressionViewModel(IEnumerable<string> hiddenProperties, IEnumerable<string> additionalProperties) : base(hiddenProperties, additionalProperties)
        {
            Init();
        }
        ...
        {
            base.SetLoadData();
          //  日期 = Helpers.DateTimeHelper.GetCurrentMonthFistDay();
           日期 = Helpers.DateTimeHelper.GetCurrentMonthCurrentDay();
          分店ID =  null;
        }
